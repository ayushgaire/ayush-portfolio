...
export const JOURNEY = [
  ...
  },
  {
    ...
    period: '2024 — Present',
    text: 'Computer Science at SMSU, founding Codyza, and building full-stack products.',
  },
]
...
export const PROJECTS = [
  {
    ...
    description:
      'A modern full-stack note-taking platform built using React, Vite, and Supabase with authentication and real-time cloud note storage.',
    features: [
      'User authentication',
      'Session management',
      'Real-time notes',
  ...
  },
  {
    ...
    description:
      'A privacy-friendly, full-stack image tool built under Codyza. Resize, optimize and transform images right in the browser — no sign-up, no third-party cloud uploads.',
    features: [
